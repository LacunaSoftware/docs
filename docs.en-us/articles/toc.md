...
#### [Checking logs](amplia/on-premises/windows/check-logs.md)
#### [Enabling ASP.NET Core stdout log](amplia/on-premises/windows/enable-stdout-log.md)
...
#### [Checking logs](amplia/on-premises/azure/check-logs.md)
#### [Enabling ASP.NET Core stdout log](amplia/on-premises/azure/enable-stdout-log.md)
