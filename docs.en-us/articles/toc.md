...
### [Biometric sessions](rest-pki/core/integration/bio-sessions/index.md)
#### [Liveness](rest-pki/core/integration/bio-sessions/liveness.md)
#### [Enrollment](rest-pki/core/integration/bio-sessions/enrollment.md)
...
### [Settings](amplia-reg/on-premises/settings/index.md)
#### [Configure Blob Storage](amplia-reg/on-premises/settings/configure-blob-storage.md)
#### [Configure OIDC](amplia-reg/on-premises/settings/configure-oidc.md)
#### [Configure email sending](amplia-reg/on-premises/settings/configure-email.md)
#### [Configure SMS sending](amplia-reg/on-premises/settings/configure-sms.md)
#### [Configure HTTPS redirection](amplia-reg/on-premises/settings/configure-https-redirect.md)
#### [Configure reCAPTCHA](amplia-reg/on-premises/settings/configure-recaptcha.md)
#### [Configure certificate renewal alert](amplia-reg/on-premises/settings/configure-certificate-renewal-alert.md)
