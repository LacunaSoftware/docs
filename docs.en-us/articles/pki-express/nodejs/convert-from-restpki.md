# How to convert from REST PKI to PKI Express in NodeJs
This articles explains the modifications necessary to convert a NodeJs application using [REST PKI](../../rest-pki/index.md) to a NodeJs application using [PKI Express](../index.md).

## Policies Equivalence
When converting your NodeJs application from using REST PKI to PKI Express, you must pay atention to the policy names used in the application.  
