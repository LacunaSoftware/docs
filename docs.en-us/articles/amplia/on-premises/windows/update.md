...
1. Extract the contents of the new package ([amplia-3.6.0.zip] (https://cdn.lacunasoftware.com/amplia/amplia-3.6.0.zip)) to the site folder, overwriting all files.
