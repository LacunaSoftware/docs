...
1. Na listagem de domínios, localize o domínio em questão (marcado com *! Not Secure*) e clique em **Add binding**
...
Por fim, volte em **Overview** do *App Service* e clique em **Start**.
