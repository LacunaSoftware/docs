...
1. Extraia o conteúdo do novo pacote do Amplia ([amplia-4.6.1.zip](https://cdn.lacunasoftware.com/amplia/amplia-4.6.1.zip)) para a pasta do site, sobrescrevendo todos os arquivos
