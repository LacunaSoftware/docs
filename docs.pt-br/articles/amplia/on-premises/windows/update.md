...
1. Extraia o conteúdo do novo pacote do Amplia ([amplia-4.5.2.zip](https://cdn.lacunasoftware.com/amplia/amplia-4.5.2.zip)) para a pasta do site, sobrescrevendo todos os arquivos
