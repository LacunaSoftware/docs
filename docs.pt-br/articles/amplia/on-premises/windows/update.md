...
1. Extraia o conteúdo do novo pacote do Amplia ([amplia-3.2.0.zip](https://cdn.lacunasoftware.com/amplia/amplia-3.2.0.zip)) para a pasta do site, sobrescrevendo todos os arquivos
