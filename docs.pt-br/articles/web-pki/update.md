...
A última versão da biblioteca de Javascript é a **2.12.0**. Você pode obtê-la no link abaixo:

https://get.webpkiplugin.com/Scripts/LacunaWebPKI/lacuna-web-pki-2.12.0.js
