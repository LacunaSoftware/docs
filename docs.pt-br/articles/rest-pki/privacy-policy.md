...
* Última alteração: 24 de maio de 2018
* Data efetiva: 25 de maio de 2018

Esta Política de Privacidade se aplica ao site [https://pki.rest](https://pki.rest) (o "Site") pertencente e operado pela Lacuna Software Ltda (coletivamente, "Lacuna", "nós", "nós" ou "nosso"). Esta Política de Privacidade descreve como a Lacuna 
coleta, usa, compartilha e protege as informações pessoais que você fornece, bem como as informações sobre os usuários finais de nossos clientes que processamos em nome de nossos clientes. Também descreve suas opções em relação ao uso, acesso, correção e exclusão de suas informações pessoais.
