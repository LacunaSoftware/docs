...
1. Extraia o conteúdo do novo pacote do Rest PKI ([restpki-1.20.2.zip](https://cdn.lacunasoftware.com/restpki/restpki-1.20.2.zip)) para a pasta do site, sobrescrevendo todos os arquivos
1. Acesse o site
