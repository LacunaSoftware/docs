...
1. Extraia o conteúdo do novo pacote do Rest PKI ([restpki-1.17.5.zip](https://files.lacunasoftware.com/restpki/restpki-1.17.5.zip)) para a pasta do site, sobrescrevendo todos os arquivos
1. Acesse o site
