...
### [Sessões de biometria](rest-pki/core/integration/bio-sessions/index.md)
#### [Prova de vida (Liveness)](rest-pki/core/integration/bio-sessions/liveness.md)
#### [Cadastro biométrico (Enrollment)](rest-pki/core/integration/bio-sessions/enrollment.md)
...
### [Setup em Azure App Services](rest-pki/core/on-premises/azure/index.md)
#### [Instalação](rest-pki/core/on-premises/azure/install.md)
#### [Atualização](rest-pki/core/on-premises/azure/update.md)
...
### [Configurações](amplia-reg/on-premises/settings/index.md)
#### [Configuração de storage](amplia-reg/on-premises/settings/configure-blob-storage.md)
#### [Configuração de OIDC](amplia-reg/on-premises/settings/configure-oidc.md)
#### [Configuração de envio de email](amplia-reg/on-premises/settings/configure-email.md)
#### [Configuração de envio de SMS](amplia-reg/on-premises/settings/configure-sms.md)
#### [Configuração de redirecionamento para HTTPS](amplia-reg/on-premises/settings/configure-https-redirect.md)
#### [Configuração de reCAPTCHA](amplia-reg/on-premises/settings/configure-recaptcha.md)
#### [Configuração de alerta de renovação de certificado](amplia-reg/on-premises/settings/configure-certificate-renewal-alert.md)
