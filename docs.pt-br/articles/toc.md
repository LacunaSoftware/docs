...
#### [Verificando os logs](amplia/on-premises/windows/check-logs.md)
#### [Habilitando o *stdout log*](amplia/on-premises/windows/enable-stdout-log.md)
...
#### [Verificando os logs](amplia/on-premises/azure/check-logs.md)
#### [Habilitando o *stdout log*](amplia/on-premises/azure/enable-stdout-log.md)
### [Resolução de problemas](amplia/on-premises/troubleshoot/index.md)
#### [HTTP Error 502.5 - ANCM Out-Of-Process Startup Failure](amplia/on-premises/troubleshoot/502-5.md)
